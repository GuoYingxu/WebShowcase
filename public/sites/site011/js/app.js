...
var scrollTo = require('../../plugins/scrollTo/jquery.scrollTo');  //页面滚动插件
var tabSwitch = require('../../plugins/tabSwitch/jquery.tabSwitch');  //标签切换插件
var toTop = require('../../plugins/toTop/jquery.toTop');  //回顶部插件
var ToTopCtrl = require('../../components/totop/toTopCtrl');  //返回顶部按钮
var layDate = require('../../plugins/laydate/laydate.dev');  //laydata日期控件
...
var Webapp = (function(){
    ...
    function Webapp(){
        ...
        //选择发货人弹窗控制
        $('#sel_sender_btn').click(function(){
            $('#sel_sender_popup').show();
        });
        $('#sel_sender_popup_mask').click(function(){
            $('#sel_sender_popup').hide();
        });
        $('#sel_sender_btn_cancel').click(function(){
            $('#sel_sender_popup').hide();
        });
        $('#sel_sender_btn_confirm').click(function(){
            $('#sel_sender_popup').hide();
        });

        //选择收货人弹窗控制
        $('#sel_receiver_btn').click(function(){
            $('#sel_receiver_popup').show();
        });
        $('#sel_sreceiver_popup_mask').click(function(){
            $('#sel_receiver_popup').hide();
        });
        $('#sel_receiver_btn_cancel').click(function(){
            $('#sel_receiver_popup').hide();
        });
        $('#sel_receiver_btn_confirm').click(function(){
            $('#sel_receiver_popup').hide();
        });

        //新增发货人弹窗控制
        $('#add_sender_btn').click(function(){
            $('#add_sender_popup').show();
        });
        $('#add_sender_popup_mask').click(function(){
            $('#add_sender_popup').hide();
        });
        $('#add_sender_btn_cancel').click(function(){
            $('#add_sender_popup').hide();
        });

        //新增收货人弹窗控制
        $('#add_receiver_btn').click(function(){
            $('#add_receiver_popup').show();
        });
        $('#add_receiver_popup_mask').click(function(){
            $('#add_receiver_popup').hide();
        });
        $('#add_receiver_btn_cancel').click(function(){
            $('#add_receiver_popup').hide();
        });

        //高级查询按钮点击控制
        $('#super_search').click(function(){
            $('#super_search_content').toggle(0,function(){
                $('#super_search_icon').toggleClass('icon-triarrow-down');
                $('#super_search_icon').toggleClass('icon-triarrow-up');
            });
        });

        //用户按钮点击控制
        $('#nav_user_btn').click(function(){
            $('.nav-user-menu').toggle(0,function(){
                $('#nav_user_btn_icon').toggleClass('icon-angelarrow-down');
                $('#nav_user_btn_icon').toggleClass('icon-angelarrow-up');
            });
            $('.nav-user-menu-arrow').toggle();
        });

        //订单详情标签控制
        $('#ordertab').tabSwitch({
            tabBtnClass : 'tabbtn',
            tabBtnActiveClass : 'sel',
            tabItemClass : 'tabcontent-order',
...
},{"../../components/totop/toTopCtrl":3,"../../plugins/laydate/laydate.dev":4,"../../plugins/scrollTo/jquery.scrollTo":5,"../../plugins/tabSwitch/jquery.tabSwitch":6,"../../plugins/toTop/jquery.toTop":7,"jquery":1}],3:[function(require,module,exports){
var ToTopCtrl = (function(){
    ...
    ToTopCtrl.prototype.getCtrlElement = function(){
        return $elem;
    }
...
;(function(factory) {
    ...
    Dates.query = function(node){
        ...
        if(!elemId){
            ...
            var find;
            var child = node[1].substr(1);
            var exp = new RegExp('\\b' + child +'\\b');
            arr = []
