...
var TabSwitch = require('./jquery.tabSwitch');
var NumSelector = require('./jquery.numSelector');
...
},{"./jquery.numSelector":3,"./jquery.tabSwitch":4,"./popbox":5,"./view/viewCtrl":6,"fastclick":1}],3:[function(require,module,exports){
/*!
 * jquery.numSelector
 * @Author Du Peng
 * @Version 0.01
...
(function (factory) {
    ...
    var NumSelectorProto = {
        init: function (options, el) {
            var base = this;
            base.$elem = $(el);
            base.options = $.extend({}, $.fn.numSelector.options, base.$elem.data(), options);
            base.userOptions = options;
            base.currentNumber = 0;

            base.$btnPlus = base.$elem.find('.' + base.options.btnPlusClass);
            base.$btnMinus = base.$elem.find('.' + base.options.btnMinusClass);
            base.$numberHtml = base.$elem.find('.' + base.options.numberHtmlClass);
            base.$numberInput = base.$elem.find('.' + base.options.numberInputClass);

            base.getCurrentNumber();
            base.setHideOnZero();
        ...
        getCurrentNumber: function () {
            var base = this;
            if (parseInt(base.$numberHtml.html()) >= 0) {
                base.currentNumber = parseInt(base.$numberHtml.text());
                base.$numberInput.attr('value', base.currentNumber);
            }
        },
        ...
        setCurrentNumber: function () {
            var base = this;
            base.$numberInput.attr('value', base.currentNumber);
            base.$numberHtml.text(base.currentNumber);
        },

        //当hideOnZero选项为true时，判断对应内容的显示和隐藏
        setHideOnZero: function () {
            var base = this;
            if (base.options.hideOnZero) {
                if (base.currentNumber == 0) {
                    base.$btnMinus.hide();
                    base.$numberHtml.hide();
                } else {
                    base.$btnMinus.show();
                    base.$numberHtml.show();
                }
            }
        },
        ...
        btnActions: function () {
            var base = this;
            base.$btnMinus.click(function () {
                if (base.currentNumber > 0) {
                    base.currentNumber -= 1;
                    base.setCurrentNumber();
                    base.setHideOnZero();
                    if (typeof base.options.afterMinus === "function") {
                        base.options.afterMinus.apply(this, [base.$elem]);
                    }
                }
            });
            base.$btnPlus.click(function () {
                base.currentNumber += 1;
                base.setCurrentNumber();
                base.setHideOnZero();
                if (typeof base.options.afterPlus === "function") {
                    base.options.afterPlus.apply(this, [base.$elem]);
                }
            });
    ...
    $.fn.numSelector = function (options) {
        return this.each(function () {
            if ($(this).data("numSelector-init") === true) {
                return false;
            }
            $(this).data("numSelector-init", true);
            var obj = Object.create(NumSelectorProto);

            $.data(this, "numSelector", obj);
            obj.init(options, this);
        });
    };
    $.fn.numSelector.options = {
        hideOnZero: false, //当0的时候，隐藏减小按钮和数字

        btnPlusClass: 'btn-plus',
        btnMinusClass: 'btn-minus',
        numberHtmlClass: 'num-input',
        numberInputClass: 'num-input-value',
...
(function (factory) {
    ...
    var TabSwitchProto = {
        ...
        switchTab: function (id) {
            ...
            if (typeof base.options.afterTab === "function") {
                base.options.afterTab.apply(this, [base.$elem]);
            }
        },
...
(function (factory) {
    ...
    Popbox.prototype.toggle = function (e) {
        ...
        if (!isActive) {
            ...
            if ('ontouchstart' in document.documentElement && !$parent.closest('.navbar-nav').length || $parent.hasClass('popbox-model')) {
                // if mobile we use a backdrop because click events don't delegate
                $(document.createElement('div')).addClass('popbox-backdrop').insertAfter($parent).on('click', clearPopboxes);
            }
            var relatedTarget = { relatedTarget: this };
